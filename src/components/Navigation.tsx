          ...
          <div className="flex items-center bg-slate-50 p-1.5 rounded-full border border-slate-100">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`px-5 py-2 text-sm font-bold tracking-wide rounded-full transition-all duration-300 ${
                  isActive(link.path) 
                ...
                <div className="px-4 py-6 space-y-1.5">
                  {navLinks.map((link, index) => (
                    ...
                    >
                      <Link 
                        to={link.path} 
                        className={`flex items-center justify-between px-5 py-4 text-base font-bold rounded-xl transition-all duration-200 group ${
                          isActive(link.path) 
